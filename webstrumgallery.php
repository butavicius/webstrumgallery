...
class Webstrumgallery extends Module
{
    ...
    public function getContent()
    {
         ...
         */
        if (((bool)Tools::isSubmit('submitWebstrumgalleryModule')) == true) {
            $this->postProcess();
        }
            ...
            'form' => array(
                ...
                'input' => array(
                    array(
                        ...
                        'name' => 'WEBSTRUMGALLERY_LIVE_MODE',
                        'is_bool' => true,
                    ...
                    array(
                        ...
                        'name' => 'WEBSTRUMGALLERY_ACCOUNT_EMAIL',
                        'label' => $this->l('Email'),
                    ),
                    array(
                        'type' => 'password',
                        'name' => 'WEBSTRUMGALLERY_ACCOUNT_PASSWORD',
    ...
    {
        return array(
            'WEBSTRUMGALLERY_LIVE_MODE' => Configuration::get('WEBSTRUMGALLERY_LIVE_MODE', true),
            'WEBSTRUMGALLERY_ACCOUNT_EMAIL' => Configuration::get('WEBSTRUMGALLERY_ACCOUNT_EMAIL', 'contact@prestashop.com'),
            'WEBSTRUMGALLERY_ACCOUNT_PASSWORD' => Configuration::get('WEBSTRUMGALLERY_ACCOUNT_PASSWORD', null),
        );
    }
